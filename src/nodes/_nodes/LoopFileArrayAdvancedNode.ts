...
const doc = [
    //
    "Loop over an array of file objects.",
    "Expects an array of file objects as input.",
...
export const LoopFileArrayAdvancedNode = makeNode(
    {
        nodeName: "LoopFileArrayAdvancedNode",
